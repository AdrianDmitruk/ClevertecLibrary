...
export const TermsPage: FC<TermsPageProps> = (props) => {
  const { contentView } = props;

  return (
    <section className={styles.main}>
      <h3 className={styles.mainTitle}>
        {(contentView === 'terms' && 'Правила пользования') || (contentView === 'contract' && 'Договор оферты')}
      </h3>
      <div className={styles.mainContainer}>
        <div className={styles.mainContainerFirst}>
          <p className={styles.mainContainerTitle}>
          ...
          <p className={styles.mainContainerSubtitleFirst}>
        ...
        <div className={styles.mainContainerFirst}>
          ...
          <p className={styles.mainContainerSubtitleSecond}>
        ...
        <div className={styles.mainContainerFirst}>
          ...
          <p className={styles.mainContainerSubtitleTherd}>
